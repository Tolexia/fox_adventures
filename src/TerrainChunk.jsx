...
export default function TerrainChunk({ x, z,offsetX, offsetZ, chunkSize, planeSize, material }) {
    ...
    return (
        <group position={[offsetX, 0, offsetZ]}>
            <RigidBody type="fixed" colliders={false} friction={1}>
                ...
                <HeightfieldCollider 
                    args={[terrainData.nsubdivs, terrainData.nsubdivs, terrainData.heights, terrainData.scale]}
                    restitution={0.2}
                />
